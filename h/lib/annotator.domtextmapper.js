...
(function() {
  ...
  Annotator.Plugin.DomTextMapper = (function(_super) {
    ...
    DomTextMapper.prototype.pluginInit = function() {
      ...
      return this.annotator.anchoring.documentAccessStrategies.unshift({
        ...
        get: function() {
          ...
          options.rootNode.addEventListener("corpusChange", function() {
            var t0;
            t0 = mapper.timestamp();
            return _this.annotator.anchoring._reanchorAllAnnotations("corpus change").then(function() {
              var t1;
              t1 = mapper.timestamp();
