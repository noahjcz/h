...
(function() {
  ...
  Annotator.Plugin.ImageAnchors = (function(_super) {
    ...
    ImageAnchors.prototype._onMutation = function(summaries) {
      var hasSelectorWithThisImageSource, highlights, hl, image, oldImage, oldsrc, summary, _i, _len, _ref1, _results,
        _this = this;
      _results = [];
        ...
        if ((_ref1 = summary.attributeChanged.src) != null ? _ref1.length : void 0) {
          _results.push((function() {
            ...
            for (_j = 0, _len1 = _ref2.length; _j < _len1; _j++) {
              ...
              oldImage = this.images[oldsrc];
              highlights = this.annotorious.getHighlightsForImage(oldImage);
              for (_k = 0, _len2 = highlights.length; _k < _len2; _k++) {
                hl = highlights[_k];
                hl.anchor.remove();
              }
              delete this.images[oldsrc];
              this.annotorious.removeImage(oldImage);
              this.images[image.src] = image;
              this.annotorious.addImage(image);
              hasSelectorWithThisImageSource = function(t) {
                var img_selector;
                console.log('hasSelectorWithThisImageSource', t, image.src);
                img_selector = this.annotator.findSelector(t, 'ShapeSelector');
                return (img_selector != null ? img_selector.source : void 0) === image.src;
              };
              _results1.push(this.annotator._anchorAllAnnotations(hasSelectorWithThisImageSource));
            }
            return _results1;
          }).call(this));
        } else {
