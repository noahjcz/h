...
(function() {
  ...
  ImageHighlight = (function(_super) {
    ...
    function ImageHighlight(anchor, pageIndex, image, index, shape, geometry, annotorious) {
      ...
      this.annotoriousAnnotation = {
        ...
        reply_count: this.annotation.reply_count,
    ...
    ImageHighlight.prototype.annotationUpdated = function() {
      ...
      this.annotoriousAnnotation.user = this.annotation.user;
      this.annotoriousAnnotation.reply_count = this.annotation.reply_count;
  ...
  Annotator.Plugin.ImageAnchors = (function(_super) {
    ...
    ImageAnchors.prototype.pluginInit = function() {
      ...
      style.text([".annotorious-annotationlayer {", "  z-index: " + (this.annotator.maxZIndex + 10) + ";", "}", ".annotorious-popup {", "  z-index: " + (this.annotator.maxZIndex + 20) + ";", "}"].join("\n"));
