...
(function() {
  ...
  ImageHighlight = (function(_super) {
    ...
    function ImageHighlight(anchor, pageIndex, image, shape, geometry, annotorious) {
      ...
      if (this.annotation.temporaryImageID) {
        this.annotoriousAnnotation = this.annotorious.updateAnnotationAfterCreatingAnnotatorHighlight(this.annotoriousAnnotation, image);
    ...
    ImageHighlight.prototype.setActive = function(value, batch) {
      ...
      this.active = value;
      if (!batch) {
        return this.annotorious.drawAnnotationHighlights(this._image, this.visibleHighlight);
      }
    };
    ...
    ImageHighlight.prototype.setVisibleHighlight = function(state, batch) {
      ...
      if (state) {
        this.annotorious.updateShapeStyle(this._image, this.annotoriousAnnotation, this.highlightStyle);
      } else {
        this.annotorious.updateShapeStyle(this._image, this.annotoriousAnnotation, this.defaultStyle);
      }
      if (!batch) {
        return this.annotorious.drawAnnotationHighlights(this._image, this.visibleHighlight);
      }
  ...
  Annotator.Plugin.ImageAnchors = (function(_super) {
    ...
    ImageAnchors.prototype.pluginInit = function() {
      ...
      this.annotorious = new Annotorious.ImagePlugin(wrapper, {}, this);
      ...
      this.annotator.subscribe("finalizeHighlights", function() {
        var error, imageList, src, _ref1, _results;
        _ref1 = _this._imageMap;
        _results = [];
        for (src in _ref1) {
          imageList = _ref1[src];
          _results.push((function() {
            ...
            _results1 = [];
            for (_j = 0, _len1 = imageList.length; _j < _len1; _j++) {
              image = imageList[_j];
              try {
                _results1.push(this.annotorious.drawAnnotationHighlights(image, this.visibleHighlights));
              } catch (_error) {
                error = _error;
    ...
    ImageAnchors.prototype._removeImage = function(image) {
      ...
      return this.annotorious.removeImage(image);
    };
    ...
    ImageAnchors.prototype.setHighlightsVisible = function(state) {
      var hl, image, imageHighlights, imageList, src, _i, _len, _ref1, _results;
    ...
    ImageAnchors.prototype._findAndVerifyImageForSelector = function(selector) {
      var candidate, idCandidate, image, imageList, _i, _len;
      image = void 0;
      ...
      if (imageList != null) {
        ...
        if (candidate != null) {
          if (selector.id != null) {
            if ((candidate.id != null) === selector.id) {
              image = candidate;
            } else {
    ...
    ImageAnchors.prototype.createImageAnchor = function(annotation, target) {
      ...
      image = this._findAndVerifyImageForSelector(selector);
      if (!image) {
