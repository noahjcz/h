...
(function() {
  ...
  Annotator.Plugin.ImageAnchors = (function(_super) {
    ...
    ImageAnchors.prototype.pluginInit = function() {
      ...
      style.text([".annotorious-selection-in-progress {", "  z-index: " + (this.annotator.maxZIndex + 10) + ";", "}", ".annotorious-popup {", "  z-index: " + (this.annotator.maxZIndex + 20) + ";", "}"].join("\n"));
