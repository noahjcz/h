...
(function() {
  ...
  Annotator = (function(_super) {
    ...
    Annotator.prototype.anchorAnnotation = function(annotation) {
      var dfd, index, promises, t, _ref1, _ref2,
        _this = this;
      annotation.quote = [];
      ...
      annotation.anchors = [];
      if ((_ref1 = annotation.target) != null ? _ref1.length : void 0) {
        promises = (function() {
          var _k, _ref2, _results,
            _this = this;
          _results = [];
          for (index = _k = 0, _ref2 = annotation.target.length - 1; 0 <= _ref2 ? _k <= _ref2 : _k >= _ref2; index = 0 <= _ref2 ? ++_k : --_k) {
            t = annotation.target[index];
            _results.push(this.createAnchor(annotation, t).then(function(anchor) {
              var pageIndex, _base, _l, _ref3, _ref4;
      ...
      dfd = this.Annotator.$.Deferred();
      (_ref2 = this.Annotator.$).when.apply(_ref2, promises).always(function() {
