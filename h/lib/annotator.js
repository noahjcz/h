...
(function() {
  ...
  Util.removeFromList = function(element, list) {
    var index, _ref1;
    index = list.indexOf(element);
    if (index !== -1) {
      [].splice.apply(list, [index, index - index + 1].concat(_ref1 = [])), _ref1;
    }
    return null;
  };
  ...
  Anchor = (function() {
        ...
        for (_l = 0, _len2 = pagesTodo.length; _l < _len2; _l++) {
          ...
          if (this.highlight[page]) {
            try {
              ...
              _results1.push(console.log("Removed LH from page", page));
            } catch (_error) {
              hlError = _error;
              _results1.push(console.log("Could not remove HL from page", page, ":", hlError.stack));
            }
          }
        }
        return _results1;
    ...
    Anchor.prototype.remove = function(removeFromAnnotation) {
      ...
      if (removeFromAnnotation) {
        return Util.removeFromList(this, this.annotation.anchors);
      }
    };
  ...
  Annotator = (function(_super) {
    ...
    Annotator.prototype.setupAnnotation = function(annotation) {
      ...
      return this.anchorAnnotation(annotation);
    };
    ...
    Annotator.prototype.anchorAnnotation = function(annotation) {
      var dfd, index, promises, t, _ref1,
        _this = this;
      ...
      promises = (function() {
        ...
        for (_k = 0, _len2 = _ref1.length; _k < _len2; _k++) {
          t = _ref1[_k];
          if (!(!this._hasAnchorForTarget(annotation, t))) {
            continue;
          }
          index = annotation.target.indexOf(t);
          _results.push(this.createAnchor(annotation, t).then(function(anchor) {
            var pageIndex, _base, _l, _ref2, _ref3;
      ...
      (_ref1 = Annotator.$).when.apply(_ref1, promises).always(function() {
        var _ref1, _ref2;
        if (((_ref1 = annotation.target) != null ? _ref1.length : void 0) && !((_ref2 = annotation.anchors) != null ? _ref2.length : void 0)) {
          console.log("Could not create anchor for annotation", annotation.id);
          if (__indexOf.call(_this.orphans, annotation) < 0) {
            _this.orphans.push(annotation);
          }
        } else {
          Util.removeFromList(annotation, _this.orphans);
        }
    ...
    Annotator.prototype._reanchorAnnotations = function(shouldTouch) {
      var anchor, anchors, annotation, annotations, page, _k, _l, _len2, _len3, _ref1, _ref2;
      if (shouldTouch == null) {
        shouldTouch = function(anchor) {
          return true;
        };
      }
