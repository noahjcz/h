...
(function() {
  ...
  Annotator = (function(_super) {
    ...
    Annotator.prototype._scan = function() {
      ...
      dfd = this.domMapper.scan();
      if (!dfd) {
        dfd = $.Deferred();
        dfd.resolve();
      }
      dfd.then(this.enableAnnotating());
      return dfd.promise();
    };
    ...
    Annotator.prototype.createAnchor = function(annotation, target) {
      ...
      deferred = this.Annotator.$.Deferred();
      this._createAnchorWithStrategies(annotation, target, this.anchoringStrategies.slice(), deferred);
    ...
    Annotator.prototype.setupAnnotation = function(annotation) {
      ...
      promises = (function() {
        var _k, _ref1, _results,
          _this = this;
        _results = [];
        for (index = _k = 0, _ref1 = annotation.target.length - 1; 0 <= _ref1 ? _k <= _ref1 : _k >= _ref1; index = 0 <= _ref1 ? ++_k : --_k) {
          ...
          _results.push(this.createAnchor(annotation, t).then(function(anchor) {
            ...
            return console.log("Could not create anchor for annotation '", annotation.id, "'.");
          }));
        }
        return _results;
      }).call(this);
      dfd = this.Annotator.$.Deferred();
      (_ref1 = this.Annotator.$).when.apply(_ref1, promises).always(function() {
