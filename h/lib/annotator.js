      ...
      promises = (function() {
        ...
        for (_k = 0, _len2 = _ref1.length; _k < _len2; _k++) {
          ...
          _results.push(this.createAnchor(annotation, t).then(function(anchor) {
            ...
            return console.log("Could not create anchor for annotation '", annotation.id, "'.", __indexOf.call(_this.orphans, annotation) < 0 ? _this.orphans.push(annotation) : void 0);
          }));
        }
        return _results;
      }).call(this);
