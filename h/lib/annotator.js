...
(function() {
  ...
  Annotator = (function(_super) {
    ...
    Annotator.prototype.setupAnnotation = function(annotation) {
      ...
      return this.anchoring.onSetup(annotation);
    };
    ...
    Annotator.prototype.onAdderClick = function(event) {
      ...
      return this.setupAnnotation(annotation).then(function(annotation) {
        var cancel, cleanup, save;
        _this.anchoring.onSetTemporary(annotation, true);
        save = function() {
          cleanup();
          _this.anchoring.onSetTemporary(annotation, false);
