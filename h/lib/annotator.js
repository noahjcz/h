...
(function() {
  ...
  Annotator = (function(_super) {
    ...
    Annotator.prototype.setupAnnotation = function(annotation) {
      ...
      return (_ref2 = this.anchoring) != null ? _ref2.onSetup(annotation) : void 0;
    };
    ...
    Annotator.prototype.onAdderClick = function(event) {
      ...
      return this.setupAnnotation(annotation).then(function(annotation) {
        var cancel, cleanup, save, _ref1;
        if ((_ref1 = _this.anchoring) != null) {
          _ref1.onSetTemporary(annotation, true);
        }
        save = function() {
          var _ref2;
          cleanup();
          if ((_ref2 = _this.anchoring) != null) {
            _ref2.onSetTemporary(annotation, false);
          }
  ...
  Annotator.AnchoringManager = (function() {
    function AnchoringManager() {}

    AnchoringManager.prototype.init = function() {
      throw new Error("not implemented");
    };

    AnchoringManager.prototype.onSetup = function(annotation) {
      throw new Error("not implemented");
    };

    AnchoringManager.prototype.onDelete = function(annotation) {
      throw new Error("not implemented");
    };

    AnchoringManager.prototype.onSetTemporary = function(annotation, value) {
      throw new Error("not implemented");
    };
