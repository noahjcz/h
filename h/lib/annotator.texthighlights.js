  ...
  Annotator.Plugin.TextHighlights = (function(_super) {
    ...
    TextHighlights.prototype.pluginInit = function() {
      ...
      return this.annotator.subscribe("setVisibleHighlights", function(state) {
        ...
        if (state || _this.annotator.tool === 'highlight') {
          return _this.annotator.element.addClass(markerClass);
        } else {
          return _this.annotator.element.removeClass(markerClass);
        }
      });
    };
